...
public class SungJukAppUI_MY extends JFrame implements ActionListener {
	//선언부
	JLabel jlb_inwon = 
			new JLabel
	...
	JButton jbtn_inputData = new JButton("데이터 넣기");
 ...
 */
	...
	public void initDisplay(){
		...
		jbtn_inputData.addActionListener(this);
	...
	public static void main(String[] args) {
		...
		SungJukAppUI_MY sja = new SungJukAppUI_MY();
		sja.initDisplay();
	}
	@Override
	public void actionPerformed(ActionEvent e) {
		if(e.getSource()==jtf_inwon 			//KeyListener로 엔터버튼 처리 안 해줘도 jtf는 기본이 엔터로 반응하기 때문에 이렇게만 해도 OK.
		|| e.getSource()==jbtn_create){
			jp3.add(jbtn_inputData);
