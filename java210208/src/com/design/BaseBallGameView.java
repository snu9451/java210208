...
public class BaseBallGameView {
	...
	//컴파일 타임에 인스턴스화 하는 것은 즉, 이른 인스턴스화를 하는 것은 멀티스레드에서 안전하지 않다. 메모리 문제를 유발한다.
	//그래서 궁극에는 싱글톤으로 가야한다.
	BaseBallGameLogic	bbgLogic = new BaseBallGameLogic();
	BaseBallGameEvent	bbgEvent = new BaseBallGameEvent(this, bbgView);	//Event와 View는 서로 관련이 있다. 영향을 주고 받는다.
															//Event 감지 시 1S 2B 등을 찍으려면 Logic과도 연결되어야 함.
	////////////   메뉴바 추가하기 ///////////////
